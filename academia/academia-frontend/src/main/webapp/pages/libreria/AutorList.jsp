...
<div class="bloque" id="bloque">    	
	<h3><span>Listado</span></h3>
   	<div class="cuerpo">
		...
		function add()	{
			$('#fullPage').load('/academia-frontend/libreria/AutorAction!add.do?decorator=none');
		}

		function edit()	{
			call('/academia-frontend/libreria/AutorAction!edit.do?decorator=none&id=' + selectedId);
		}
		
		function eliminar()	{
			call('/academia-frontend/libreria/AutorAction!destroy.do?decorator=none&id=' + selectedId);			
		}

		function show()	{
			call('/academia-frontend/libreria/AutorAction!show.do?decorator=none&id=' + selectedId);
		}
		...
		function call(urlString) {
			if(selectedId != -1){ 
				...
				showInfoMsg('Debe seleccionar un Autor.<br>');
			}
			return false;
		}
