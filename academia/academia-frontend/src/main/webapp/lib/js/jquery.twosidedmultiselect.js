(function($) {
	...
	$.fn.twosidedmultiselect = function() {
		...
		return this.each(function() {
			...
			/* 	Se modificaron los "titles" al español
				Se quitaron los caracteres <, <<, >, >> 
				Se agregaron las clases de <p> a globas.css    - MG
			*/
			...
			"<p class=\"AddOne\" rel=\"" + newId + "\" title=\"Agregar Seleccionado\">&nbsp;</p>" +
			"<p class=\"AddAll\" rel=\"" + newId + "\" title=\"Agregar Todos\">&nbsp;</p>" +
			"<p class=\"RemoveOne\" rel=\"" + newId + "\" title=\"Quitar Seleccionado\">&nbsp;</p>" +
			"<p class=\"RemoveAll\" rel=\"" + newId + "\" title=\"Quitar Todos\">&nbsp;</p>" +
			"</div>" +
			"<div class=\"" + nameModifier + "select\">" +
			"<select style=\"width: 200px;\" name=\"" + originalName + arrayName + "\" id=\"" + newId + "\" size=\"" + size + "\"multiple=\"multiple\" size=\"8\" class=\"TakeOver\"></select>" +
			"</div>";
